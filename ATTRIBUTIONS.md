...
**Key permissions:**
- ✅ Use, study, copy, merge, embed, modify, redistribute
- ✅ Can be bundled/sold with software
- ✅ Free of charge

**Key conditions:**
- ⚠️ Font cannot be sold by itself
- ⚠️ Modified versions cannot use reserved font name without permission
- ⚠️ Must remain under OFL license
...
**Source:** [SVG Repo - License Icon](https://www.svgrepo.com/svg/508106/license)  
**Author:** scarlab  
**License:** MIT License
...
All third-party assets used in this project are properly licensed for use in open-source software. Users are free to use, modify, and distribute this application under the terms specified in the LICENSE file, with the understanding that third-party assets remain under their respective licenses.
